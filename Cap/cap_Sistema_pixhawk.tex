...
A preparação do Pixhawk para voo consiste em duas etapas, instalação do {\it firmware} no dispositivo e a calibração dos sensores ligados a ele. As próximas seções descrevem em detalhe essas duas etapas. A documentação oficial do Pixhawk pode ser encontrada no link \url{http://ardupilot.org/ardupilot/index.html#}.

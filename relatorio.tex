...
\documentclass[a4paper,twoside,brazil,11pt,a4paper,openright,titlepage,usenames,dvipsnames]{book}
...
{fontsize=\footnotesize,
 ...
 %
 label=\fbox{\color{Black}resultado\_MAVLink.txt},
...
\titulolinhai{DESENVOLVIMENTO DE UM SISTEMA COM}

\titulolinhaii{VEÍCULOS AÉREOS NÃO-TRIPULADOS AUTÔNOMOS}
...
\input{Cap/cap_Introducao}
\input{Cap/cap_Sistema}
\input{Cap/cap_Sistema_pixhawk}
\input{Cap/cap_Sistema_gumstix}
\input{Cap/cap_Sistema_mavlink}
\input{Cap/cap_Sistema_radios}
\input{Cap/cap_Resultados}
\input{Cap/cap_Conclusoes}
